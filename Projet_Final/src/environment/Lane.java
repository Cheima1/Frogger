...
public class Lane {
    ...
    public void addSpecialCase() {
        specialCase = new Car(this.game, new Case((int)(Math.random() * game.width - 1), this.ord), true);
    }
    ...
    public void update() {
        ...
        if (specialCase != null) {
            specialCase.addSpecToGraphics(ord);
        }
    ...
    public boolean isSafe(Case frogPos) {
        ...
        if (specialCase != null) {
            return !specialCase.isAccident(frogPos);
        }
        return true;
    }
